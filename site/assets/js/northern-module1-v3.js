(() => {
  ...
  const regional=document.createElement('aside');regional.className='m1RegionalNote';regional.innerHTML='<b>Northern Arizona Regional Opportunity:</b> BOOST considers current employment, average annual openings, projected growth, and wages across Apache, Coconino, Gila, and Navajo Counties. The Recommendation Gate controls only what BOOST proactively surfaces; every occupation remains available for you and your Career Coach to explore.';title.insertAdjacentElement('afterend',regional);
